...
public class BoardTest {
	...
	private Tile tile_1_1, tile_1_2, tile_2_1, tile_2_2, tile_1_3, tile_3_2;
	...
	public void setUp() throws Exception {
		...
		tile_1_3 = board.tileAt(1, 3);
		tile_3_2 = board.tileAt(3, 2);
	...
	public void testOnBoardMessage() {
		...
		fail("Test Failed");
			...
			String message = "PRE: (-1, -1)not on board of size " + WIDTH + " * " + HEIGHT;
	 ...
	 * operation with first member
	 */
	@Test
	public void testTileAtOffsetMore() {
		assertThat(board.tileAtOffset(tile_1_1, -(WIDTH * 2), 2), equalTo(tile_1_3));
	}
