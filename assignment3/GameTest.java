...
public class GameTest {
	 ...
	 */
	@Test 
	public void testObserverAttachAndGetBoardInspector() throws FactoryException {
		// given
		Observer anObserver = mock(Observer.class);
		Game game2 = makePlay("G #");
		game2.attach(anObserver);
		Ghost ghost = (Ghost) game2.getBoardInspector().spriteAt(0, 0); 
		// when
	 ...
	 */
	@Test
	public void testPlayerMovesToGhostAndDied() throws FactoryException {		
		Game g = makePlay("PG#");
		Player p = g.getPlayer();
