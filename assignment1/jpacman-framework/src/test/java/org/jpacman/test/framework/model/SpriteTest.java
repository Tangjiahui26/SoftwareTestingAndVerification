...
public class SpriteTest {
	...
	/**
	 * Test toString() and getSpriteType() according
	 * to mutation analysis result.
	 */
	@Test
	public void testGetSpriteTypeAndToString() {
		assertThat(john.getSpriteType(), equalTo(SpriteType.OTHER));
		String str = john.getSpriteType().toString() + " occupying " + john.getTile();
		assertThat(john.toString(), equalTo(str));
	}
