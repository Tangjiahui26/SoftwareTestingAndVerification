...
public class ErrorTestMinimized {
    ...
    public void test057() throws Throwable {
        Game game0 = new Game();
        Board board9 = new Board(0, 20);
        game0.setBoard(board9);
        Ghost ghost27 = new Ghost();
        Direction direction40 = Direction.RIGHT;
    ...
    public void test059() throws Throwable {
        ...
        level0.parseMap();
        Game game3 = level0.getGame();
        Ghost ghost29 = new Ghost();
        Direction direction49 = Direction.RIGHT;
    ...
    public void test086() throws Throwable {
        Game game0 = new Game();
        Board board5 = new Board(0, 20);
        game0.setBoard(board5);
        Ghost ghost73 = new Ghost();
        Player player83 = new Player();
        Direction direction97 = player83.getDirection();
    ...
    public void test088() throws Throwable {
        ...
        Direction direction28 = player10.getDirection();
    ...
    public void test103() throws Throwable {
        ...
        Ghost ghost25 = new Ghost();
        Direction direction48 = Direction.DOWN;
    ...
    public void test123() throws Throwable {
        Level level0 = new Level();
        level0.parseMap();
        Game game14 = level0.getGame();
        Ghost ghost27 = new Ghost();
        Player player32 = new Player();
        Direction direction38 = player32.getDirection();
